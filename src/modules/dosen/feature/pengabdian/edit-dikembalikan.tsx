...
interface EditDikembalikanPengabdianProps {
  id: string
}

export default function EditDikembalikanPengabdian({
  id
}: EditDikembalikanPengabdianProps) {
  ...
  const { mutateAsync: upload } = useUploadPengabdian({
    onSuccess(res) {
