...
export default function ModalDosen() {
  ...
  return (
    <Modal
      title='Daftar dosen pengabdian'
      name='tambah dosen'
      open={openModal}
      setOpen={setOpenModal}
      description='Menampilkan daftar dosen yang akan terlibat dalam pengabdian'
      tooltipContent='Klik untuk melihat detail dosen pengabdian'
      className='max-w-3xl'
    >
