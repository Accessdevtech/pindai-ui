...
import {
  ...
  createOptionalTextAreaValidation,
...
export type PenelitianDiscriminatedType = z.infer<typeof penelitianDiscriminatedSchema>
...
export const validatePenelitianDraft = (data: unknown) => {
  ...
  const filledFields = Object.entries(draftResult.data)
